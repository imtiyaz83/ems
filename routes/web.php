...
// routes speaker registration
Route::post('/register', [SpeakerController::class, 'register'])->name('register');
Route::get('/register', [SpeakerController::class, 'register'])->name('register.show');
